...
<html lang="en">
    <head>
        ...
        <script src="{{asset('media/js/jquery-3.6.4.min.js')}}"></script>
            ...
            <div class="head-top container-fluid">
                <div class="container px-4">
                    <div class="row align-items-center justify-content-center gx-5">
                        ...
                        <div class="col-2 d-flex justify-content-center">
                            @if($end == 'tickets')
                                    <a class="btn btn-lg btn-secondary border" role="button" id="" aria-expanded="false">
                                        <i class="bi bi-journal-richtext"></i>
                                        <strong>Tickets</strong>
                                    </a>
                                    @else
                                    <a class="btn btn-lg" role="button" id="" aria-expanded="false" href="{{asset('tickets')}}">
                                        <i class="bi bi-journal-richtext"></i>
                                        Tickets
                                    </a>
                                @endif
                        ...
                        <div class="col-4 d-flex justify-content-center">
                            <form action="{{asset('/search')}}" name="search" method="GET" class="search">
                        ...
                        <div class="col-2 d-flex justify-content-center">
                            @if($end == 'ticket')
                                    <a class="btn btn-lg btn-secondary" role="button" id="" aria-expanded="false">
                                        <i class="bi bi-plus-square-fill"></i>
                                        Add a ticket
                                    </a>
                                    @else
                                    <a class="btn btn-lg" role="button" id="" aria-expanded="false" href="{{asset('ticket')}}">
                        ...
                        <div class="col-2 d-flex justify-content-center">
                            <div class="dropdown col-lg-2 col-sm-3 col-3 my-profil">
                                @if(Auth::user())
                                <a class="btn btn-lg dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{asset('ticket/message')}}">Мои сообщения</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{asset('profile')}}">Настройки профиля</a>
                                    </li>
                    ...
                    <div class="col-sm">
                            ...
                            <ul class="">
                                <li class="nav-item ">
                                    ...
                                    @else
                                    <a class="nav-link" href="{{asset('aboutus')}}">About</a>
                                    @endif
                                </li>
                                <li class="nav-item">
                                    @if($end == 'help')
                                    <p><strong>Сontacts</strong></p>
                                    @else
                                    <a class="nav-link" href="{{asset('help')}}">Сontacts</a>
                                    @endif
                                </li>
                                <li class="nav-item">
                                    @if($end == 'tickets')
